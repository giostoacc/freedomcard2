...
This project is ready to publish as a static site using GitHub Pages. Follow these steps after pushing the `work` or `main` branch to your GitHub repository:
...
2. **Trigger a deployment**
   - Push to `main` or `work`, or manually run the "Deploy static site to GitHub Pages" workflow via the **Actions** tab.
